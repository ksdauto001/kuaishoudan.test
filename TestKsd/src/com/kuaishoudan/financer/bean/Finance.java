...
public class Finance {
	...
	public int financeid;// id
	public String username;// 客户名
	public String phone;// 手机
	int brandid;// 品牌id
	String brandname;// 品牌名称
	int seriesid;// 系列
	String seriesname;// 系列名称
	double carprice;// 汽车价格(万)
	int productid;// 产品id
	String productname;// 产品名称
	double loanamount;// 贷款金额(万)
	int payperiods;// 周期
	long compactno;// 合同号
	int statues;// 状态
	int supplierid;// 商户id
	String suppliername;// 商户名称
	String remark;// 备注
	int cityid;// 城市id
	String reason;// 原因
	int organizationid;// 机构id
	...
	public long getCompactno() {
		return compactno;
	}

	public void setCompactno(long compactno) {
